...
RegisterServerEvent("instanceplayer:set")
AddEventHandler("instanceplayer:set", function(set)
...
RegisterServerEvent("instanceplayer:setNamed2")
AddEventHandler("instanceplayer:setNamed2", function(source,setName)
...
RegisterServerEvent("instanceplayer:setNamed")
AddEventHandler("instanceplayer:setNamed", function(setName)
