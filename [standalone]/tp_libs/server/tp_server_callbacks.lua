...
function ServerRPC:Trigger(_source, uniqueId, isSync, ...)
    ...
    self._callback(_source, function(...)
        TriggerClientEvent("tp_libs:ServerCallback", _source, uniqueId, isSync, ...)
    end, ...)
end
...
RegisterNetEvent("tp_libs:addNewCallBack", ServerRPC.Callback.Register)
...
function ServerRPC:TriggerRpcAsync(source, ...)
    ...
    TriggerClientEvent("tp_libs:TriggerServerCallback", source, self.name, self.uniqueId, false, ...)
...
function ServerRPC:TriggerRpcAwait(source, ...)
    ...
    self.uniqueId = self.name .. tostring(callBackId)
    TriggerClientEvent("tp_libs:TriggerServerCallback", source, self.name, self.uniqueId, true, ...)
