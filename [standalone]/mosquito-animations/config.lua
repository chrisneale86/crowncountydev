Config = {}
Config.Debug = false -- ensure that this is false on live servers.
...
Config.SitBehindControl = "INPUT_FRONTEND_DOWN" -- The control to use for the sit behind action, will be shown when quick emote menu is open.
Config.SitBehindPromptText = "Take a seat behind"
Config.SitLedgeControl = "INPUT_FRONTEND_UP"    -- The control to use for the sit ledge action
...
Config.PointControl = { Keyboard = "INPUT_OPEN_SATCHEL_MENU", Controller = "INPUT_CREATOR_RS" } -- Conntrols to use for pointing, for keyboard and controller separately
Config.PointingWalkSpeed = 2.0
Config.PointingDrawPointer = true                                                               -- Draw the pointer/Crosshair when pointing
...
Config.RegularVORPMenuTitle = "Crown & County"
...
Config_QuickMenu.MenuLanguage = {
	...
	exitMenu = { text = "Stop Emote", color = { 255, 64, 64, 255 } },
...
Config_QuickMenu.controlIconsGamepad = {
	...
	[2] = {
		...
		switchEmoteTable = "ps4_button_4_img",
...
Config_QuickMenu.ControllerMenuControls = {
	...
	switchEmoteTable = GetHashKey("INPUT_WHISTLE"),
