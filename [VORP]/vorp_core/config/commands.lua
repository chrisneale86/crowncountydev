...
Commands = {
    ...
    heal = {
        ...
        callFunction = function(data)
            ...
            TriggerClientEvent("fred_metabolism:changeValue", tonumber(data.args[1]), "Thirst", 1000)
            TriggerClientEvent("fred_metabolism:changeValue", tonumber(data.args[1]), "Hunger", 1000)
            HealPlayers(data)
        end
    },
    addWhitelist = {
