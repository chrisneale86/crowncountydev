...
Config = {
    ...
    initInvCapacity       = 250.0,         -- Initial number of character inventory weight for new players. for old characters you must change in the database if you dont ave a new server
    ...
    savePlayersTimer      = 5,           -- Interval in minutes for automatically saving all players to the database.
    ...
    SwitchJobCoolDown     = 0,   -- Cool down time in minutes for switching jobs.
    ...
    HealthOnResurrection     = 200,                                  -- Player health after being resurrected (max is 500).
    ...
    RespawnTime              = 500,                                   -- Time in seconds before a player can respawn.
