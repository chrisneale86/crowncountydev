...
Config.BannedNames = { "Marshton", "Shit", "Dick" } --* you can add more words
...
local palettes = {
    ...
    joaat("METAPED_TINT_EYES_UI"),
    joaat("METAPED_TINT_GENERIC_CLEAN"),
    joaat("METAPED_TINT_GENERIC_WORN"),
    joaat("METAPED_TINT_SKIRT_WEATHERED"),
    joaat("METAPED_TINT_SWATCH_000"),
    joaat("METAPED_TINT_LEATHER"),
    joaat("METAPED_TINT_COMBINED_LEATHER1"),
    joaat("METAPED_TINT_COMBINED_LEATHER2"),
    joaat("METAPED_TINT_COMBINED_LEATHER3"),
    joaat("METAPED_TINT_COMBINED_LEATHER4"),
    joaat("METAPED_TINT_COMBINED_LEATHER5"),
    joaat("METAPED_TINT_COMBINED_LEATHER6"),
    joaat("METAPED_TINT_MPADV"),
    joaat("METAPED_TINT_SKIRT_WORN"),
    joaat("METAPED_TINT_HAIR"),
    joaat("METAPED_TINT_HAIR1"),
    joaat("METAPED_TINT_HAIR2"),
    joaat("METAPED_TINT_HAIR_BED"),
    joaat("METAPED_TINT_HAIR_UI"),
    joaat("METAPED_TINT_COMBINED_LEATHER"),
    joaat("METAPED_TINT_GENERIC_WEATHERED"),
    joaat("METAPED_TINT_HAT"),
    joaat("METAPED_TINT_MPADV_DEUTERANOPIA"),
    joaat("METAPED_TINT_TEETH"),
    joaat("METAPED_TINT_MPADV_PROTANOPIA"),
    joaat("METAPED_TINT_MPADV_TRITANOPIA"),
    joaat("METAPED_TINT_SI_TEMPLATE"),
