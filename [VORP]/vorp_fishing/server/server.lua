...
AddEventHandler('vorp_fishing:discord', function(fishModel, fishWeight, status, src)
    ...
    local webhook = "https://discord.com/api/webhooks/1474505973509918801/jS9TY4ckiU-zMEZlVQPdEnaC7bl4CPuOIaTzAUdmsjtenOf2mcfGGdXgkgKOvdqKUQlC" -- link here for webhook
