...
Config.Butchers = {
    ...
    },
    {
        ...
        blip = 1369919445,
        npcmodel = "S_M_M_UNIBUTCHERS_01",
        coords = vector3(-5510.371, -2946.005, -1.894515),
    ...
    },
    {
        ...
        coords = vector3(-1435.61, -2329.28, 43.66),
        heading = 1.15,
        radius = 4.0,
        showblip = true,
        butcherped = true
...
Config.SkinnableAnimals = {
    ...
    [2028722809]  = {
        ...
        givenAmount = { 1, 1 }, 
        givenDisplay = { "Boar tusk", "Pig fat" },
        money = 0, 
        gold = 0, 
        rolPoints = 0, 
        xp = 1, 
    ...
    [-22968827]   = {
        name = "Water Snake",
        givenItem = { "wsnakeskin", "snaket", "stringy", "Snake_Poison" },
        givenAmount = { 1, 1, 1, 1 },
        givenDisplay = { "Watersnake pelt", "Snake tooth", "Stringy meat", "Snake Poison" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1790499186] = {
        name = "Snake Red Boa",
        givenItem = { "boaskin", "snaket", "stringy", "Snake_Poison" },
        givenAmount = {  1, 1, 1, 1 },
        givenDisplay = { "Boa Snake pelt", "Snake tooth", "Stringy meat", "Snake Poison"  },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [1464167925]  = {
        ...
        givenItem = { "snaket", "stringy", "asnakes", "Snake_Poison" },
        givenAmount = {  1, 1, 1, 1 },
        givenDisplay = { "Fer de Lance Snake pelt", "Snake tooth", "Stringy meat", "Snake Poison"  },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [846659001]   = {
        ...
        givenItem = { "snaket", "stringy", "fsnakes", "Snake_Poison" },
        givenAmount = {  1, 1, 1, 1 },
        givenDisplay = { "Black rattletail Snake pelt", "Snake tooth", "Stringy meat", "Snake Poison" },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
    ...
    [-1747620994] = {
        name = "Legendary Boa",
        givenItem = { "stringy", "legendsnakes", "snaket", "Snake_Poison" },
        givenAmount = {  1, 1, 1, 1 },
        givenDisplay = { "Stringy meat", "Legendary Boa pelt", "Snake tooth", "Snake Poison"  },
        money = 0,
        gold = 0,
        rolPoints = 0,
        xp = 1,
