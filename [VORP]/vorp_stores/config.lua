...
Config.Stores = {
    ...
    Valentine = {
        isDeactivated = true,     -- use this to activate stores or deactivate
    ...
    BlackwaterFishing = {
        ...
        Blip = {
            ...
            sprite = 3442726182,
            Pos = vector3(-761.5013, -1360.6836, 43.7023),
        },
        Npc = {
            Pos = vector4(-764.8694, -1359.3754, 42.7115, 270.8325),     
            distanceRemoveNpc = 20.0,
            Allowed = true,
            Model = "U_M_M_NbxGeneralStoreOwner_01",
        },
    ...
    BlackwaterButcher = {
        ...
        Blip = {
            ...
            sprite = -1406874050,
            Pos = vector3(-760.5156, -1284.9233, 43.7005),
        },
        Npc = {
            Pos = vector4(-763.1124, -1284.1768, 43.7058, 275.1107),
            distanceRemoveNpc = 20.0,
            Allowed = true,
            Model = "u_m_m_sdtrapper_01",
        },
    ...
    SaintDenisButcher = {
        ...
        Blip = {
            ...
            sprite = -1406874050,
            Pos = vector3(-1753.77, -385.45, 156.51),
        },
        Npc = {
            Pos = vector4(-1753.86, -385.39, 155.51, 241.03),
            distanceRemoveNpc = 20.0,
            Allowed = true,
            Model = "u_m_m_sdtrapper_01",
        },
        storeName = "Strawberry Butcher",
        PromptName = "Butcher",
        distanceOpenStore = 3.0,
        AllowedJobs = {},
        JobGrade = 0,
