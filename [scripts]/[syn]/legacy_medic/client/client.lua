...
--========================================================
-- FIXED: removed deprecated vorp:resurrectPlayer
-- Uses your VORP Core revive wrapper event instead
--========================================================
RegisterNetEvent('legacy_medic:reviveclosest')
AddEventHandler('legacy_medic:reviveclosest', function()
    DoScreenFadeOut(800)
    ...
    Citizen.Wait(300)
    TriggerEvent("vorp_core:Client:ExternalRevive")
    DoScreenFadeIn(800)
end)
