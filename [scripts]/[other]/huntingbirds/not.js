...
exports('parrot_talk', (x,y,z, aname, sname) => {
	...
	struct1.setInt32(16, 1, true);
    struct1.setBigInt64(24, BigInt(291934926), true);
    struct1.setInt32(32, 1, true);
	struct1.setInt32(40, 1, true);
	struct1.setInt32(48, 1, true);

    Citizen.invokeNative("0xED640017ED337E45", x,y,z, struct1);
});