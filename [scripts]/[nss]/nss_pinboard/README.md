...
3. Rename [secure.demo.lua] to `secure.lua` and fill in your Discord webhook urls.
4. Execute `db.sql` on your database.
5. Add `ensure nss_pinboard` to your `server.cfg`.
...
[secure.demo.lua]: ./secure.demo.lua
