...
Config.shops = {
    ...
    blackwater = {
        ...
        boats = {
            {
                boatType = 'Portable', -- Do Not Change or Add Models/Boats to Portable Section
                ['pirogue2'] = { label = 'Canoe', cashPrice = 900, goldPrice = 17 }
            },
            {
                boatType = 'Canoes', -- Do Not Add 'pirogue2' Model as a Regular Boat
                ['canoetreetrunk'] = { label = 'Dugout Canoe',  cashPrice = 500, goldPrice = 7  },
                ['canoe']          = { label = 'Canoe',         cashPrice = 900, goldPrice = 15 },
                ['pirogue']        = { label = 'Pirogue Canoe', cashPrice = 900, goldPrice = 15 }
            },
            {
                boatType = 'Rowboats',
                ['skiff']        = { label = 'Skiff',         cashPrice = 2000, goldPrice = 24 },
                ['rowboat']      = { label = 'Rowboat',       cashPrice = 2500, goldPrice = 36 },
                ['rowboatSwamp'] = { label = 'Swamp Rowboat', cashPrice = 2500, goldPrice = 36 }
            },
            {
                boatType = 'Steamboats',
                ['boatsteam02x'] = { label = 'Steamboat', cashPrice = 5000, goldPrice = 60 },
                ['keelboat']     = { label = 'Keelboat',  cashPrice = 5000, goldPrice = 94 }
            }
        }
    },
    -----------------------------------------------------
