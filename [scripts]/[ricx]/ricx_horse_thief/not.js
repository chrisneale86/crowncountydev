...
exports('talk', (ped, aname, sname, line, sparam) => {
    const struct1 = new DataView(new ArrayBuffer(128));
    struct1.setBigInt64(0, BigInt(CreateVarString(10, "LITERAL_STRING", sname)), true);
    struct1.setBigInt64(8, BigInt(CreateVarString(10, "LITERAL_STRING", aname)), true);
    struct1.setInt32(16, line, true);
    struct1.setBigInt64(24, BigInt(GetHashKey(sparam)), true);
    struct1.setInt32(32, PlayerPedId(), true);
    struct1.setInt32(40, 1, true);
    struct1.setInt32(48, 1, true);

    Citizen.invokeNative("0x8E04FEDD28D42462", ped, struct1);
});
