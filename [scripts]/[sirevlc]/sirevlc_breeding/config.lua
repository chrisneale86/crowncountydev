...
Config.BREEDING_COOLDOWN_TIMER_PHASE_1          = 5		 -- HOW MANY MINUTES ARE REQUIRED TO GET FROM PHASE 0 to PHASE 1 ?
Config.BREEDING_COOLDOWN_TIMER_PHASE_2          = 10 		 -- HOW MANY MINUTES ARE REQUIRED TO GET FROM PHASE 1 to PHASE 2 ?
Config.BREEDING_COOLDOWN_TIMER_PHASE_3          = 15		 -- HOW MANY MINUTES ARE REQUIRED TO GET FROM PHASE 2 to PHASE 3 ?
Config.BREEDING_COOLDOWN_TIMER_PHASE_4          = 20		 -- HOW MANY MINUTES ARE REQUIRED TO GET FROM PHASE 3 to PHASE 4 ?
		 
-- AGING SYSTEM		 
Config.AGING_HORSE_AGE_FOAL_PHASE_4   	 		= 1  		 -- HOW OLD ARE FOALS WHEN THEY BECOME ADULT ?
 
 
-- GENERAL CREATION COOLDOWN 
Config.BREEDING_CREATION_COOLDOWN               = true 	     -- THIS COOLDOWN IS A GENERAL COOLDOWN FOR THE BREEDING SYSTEM ITSELF ! NOT THE COOLDOWN BETWEEN PHASES !
...
Config.WEBHOOK_HORSE_BREEDING_CREATE_EVENT   		= true 
