...
Config.SEND_BACK_NEAR_STABLES_DISTANCE 	= 50000.0
Config.DISPLAY_PROMPT_DISTANCE = 1.5
...
Config.InvincibleWagons           = true    		  -- HORSES CAN STILL DETACH
Config.InvincibleHuntingWagons    = true    		  -- HORSES CAN STILL DETACH
...
Config.StashRoleRestrictions      = false 		      -- This restricts access to the wagon locker to the jobs listed below. The wagon owner can still access their wagon locker regardless of their job.
...
Config.LOCKPICKING_ENABLED        				= false	 -- IF ENABLED PEOPLE WHO DON'T HAVE THE RIGHT JOB IN CONFIG.STASHROLES WILL BE ABLE TO LOCKPICK
...
Config.PromptSpecial                            = `INPUT_ENTER` -- E
