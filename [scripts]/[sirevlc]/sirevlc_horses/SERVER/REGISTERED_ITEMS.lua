...
-- SIREVLC HORSES   
  ...
  --
   VorpInv.RegisterUsableItem("consumable_horsepeppermints", function(data)
       local _source = data.source   
      TriggerClientEvent("SIREVLC_STABLES_ITEM_INTERACTION", _source, "FEEDING", "consumable_horsepeppermints")
       VorpInv.CloseInv(data.source)
   end)

  --
   VorpInv.RegisterUsableItem("carrotymuffin", function(data)
       local _source = data.source   
      TriggerClientEvent("SIREVLC_STABLES_ITEM_INTERACTION", _source, "FEEDING", "carrotymuffin")
       VorpInv.CloseInv(data.source)
   end)

  --
   VorpInv.RegisterUsableItem("applecookie", function(data)
       local _source = data.source   
      TriggerClientEvent("SIREVLC_STABLES_ITEM_INTERACTION", _source, "FEEDING", "applecookie")
       VorpInv.CloseInv(data.source)
   end)

  --
   VorpInv.RegisterUsableItem("mintyhaytreat", function(data)
       local _source = data.source   
      TriggerClientEvent("SIREVLC_STABLES_ITEM_INTERACTION", _source, "FEEDING", "mintyhaytreat")
       VorpInv.CloseInv(data.source)
   end)

  --
   VorpInv.RegisterUsableItem("consumable_apple", function(data)
       local _source = data.source   
      TriggerClientEvent("SIREVLC_STABLES_ITEM_INTERACTION", _source, "FEEDING", "consumable_apple")
       VorpInv.CloseInv(data.source)
   end)
   ...
   --
   VorpInv.RegisterUsableItem("consumable_horse_reviver", function(data)
       local _source = data.source   
      TriggerClientEvent("SIREVLC_STABLES_ITEM_INTERACTION", _source, "HORSE_REVIVING", "consumable_horse_reviver")
       VorpInv.CloseInv(data.source)
   end) 
