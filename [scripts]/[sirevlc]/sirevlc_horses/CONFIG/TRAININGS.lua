...
[1] = { 
			  ENABLED                   = true,
			  TYPE                      = {ONMOUNT = true, LEADING = false, LUNGING = true},	-- If both ONMOUNT and LEADING are set to true, the system will use the average of their countdown and XP values 	  
			  PLAYER_INSTANCE           = false, 											-- IF TRUE IT WILL PUT THE PLAYER IN AN INSTANCE
			  PLAYERLOCK                = false,
			  PLAYER_LIST               = {
			  [1] = {TRAINING_ACCESS = false, IDENTIFIER = "OTHER_PLAYERS", CHARID = "OTHER_PLAYERS", XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },	
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainerblk",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 172},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 150, LUNGING = 60},
			  BLIPENABLED 				= true,
			  BLIPSPRITE      			= -1327110633,
			  BLIPNAME        			= "HORSE TRAINING BLK",	 
			 ...
			 -- [8]  = { COORDS = vector3(-902.06, -1309.49, 42.43    ), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [6]  = { COORDS = vector3(-947.61, -1305.44, 49.09+0.7), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [7] = { COORDS = vector3(-973.30, -1333.05, 50.62+0.7), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [8] = { COORDS = vector3(-964.46, -1305.18, 49.36+0.7), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [9] = { COORDS = vector3(-947.61, -1305.44, 49.09+0.7), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [10] = { COORDS = vector3(-972.74, -1319.99, 50.21+0.7), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [11] = { COORDS = vector3(-962.64, -1338.97, 49.72+0.7), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },			  
			  },
...
[2] = { 
			  ENABLED                   = true,
			  TYPE                      = {ONMOUNT = true, LEADING = false, LUNGING = true},	  	  
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainersai",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 60, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 172},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 200, LEADING = 150, LUNGING = 60},
			  BLIPENABLED 				= true,
			  BLIPSPRITE      			= -1327110633,
			  BLIPNAME        		    = "HORSE TRAINING SAI",	
			  BLIPCOORDS                = vector3(2523.41, -772.5, 42.47), 	
			  PROMPTNAME                = "SAINT DENIS STABLES",			  
			  PROMPTCOORDS              = vector3(2523.41, -772.5, 42.47), 
			  PROMPTDISTANCE            = 5.0,
			  MUSICENABLED              = true,
			  MUSICUSED                 = "BOU1_START",		
			  ---------------------------------
			  ...
			  OBSTACLES_ENABLED         = true,  			  
			  OBSTACLES         		= { 
			  [1]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2509.14, -766.57, 42.26, 0.0) },   
			  [2]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2491.7, -782.72, 42.52,  0.0) },   
			  [3]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2500.61, -807.31, 42.38, 0.0) },   
			  [4]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2517.95, -840.37, 42.45, 0.0) },   
			  [5]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2534.42, -844.78, 42.37, 0.0) },   
			  [6]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2541.87, -823.74, 42.32, 0.0) },   
			  [7]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2529.37, -798.57, 42.25, 0.0) },   
		      [8]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2517.3, -776.86, 42.34, 0.0) },   
			--   [9]  = {ENABLED = true, MODEL = "P_BARREL03X", COORDS = vector4(2573.92, -842.46, 41.25, 0.0) },   
			  ...
			  STARTPLAYERCOORDS         = vector4(2523.13, -772.57, 42.41, 103.07),
			  CHECKPOINTS               = {
			  [1]  = { COORDS = vector3(2507.18, -766.42, 41.31), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },    
			  [2]  = { COORDS = vector3(2489.94, -781.54, 41.38), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			  [3]  = { COORDS = vector3(2499.21, -807.67, 41.36), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			  [4]  = { COORDS = vector3(2517.01, -841.54, 41.31), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			  [5]  = { COORDS = vector3(2534.96, -847.18, 41.29), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			  [6]  = { COORDS = vector3(2543.37, -823.0, 41.32), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			  [7]  = { COORDS = vector3(2531.16, -798.01, 41.23), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			 [8]  = { COORDS = vector3(2518.68, -776.05, 41.35), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },
			...
			--   [14] = { COORDS = vector3(2568.99, -842.44, 41.39), DETECTIONDISTANCE = 3.0 , RGB = {138,138,138} },			  
			  ...
			  ---------------------------------
			  ---------------------------------
			  LUNGING_START_PLAYER_COORDS       = vector4(2513.26, -804.53, 42.32, 201.48),
			  LUNGING_OBSTACLES_ENABLED         = false, 				  
			  LUNGING_OBSTACLES         		= { 
...
[3] = { 
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainertum",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 172},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 150, LUNGING = 60},	
			  BLIPENABLED 				= true,
			  BLIPSPRITE      		    = -1327110633,
			  BLIPNAME        		    = "HORSE TRAINING TUM",	  
...
-- PRONGHORN RANCH
      [4] = {
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainerpro",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 70},
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 120, LUNGING = 60},	
			  BLIPENABLED 				= false,
			  BLIPSPRITE      			= -1327110633,
			  BLIPNAME        			= "HORSE TRAINING PRO",	  
...
-- EMERALD RANCH
      [5] = { 
			  ...
			  PLAYERLOCK                = false,
			  PLAYER_LIST               = {
			  [1] = {TRAINING_ACCESS = false, IDENTIFIER = "OTHER_PLAYERS", CHARID = "OTHER_PLAYERS", XPGIVEN = {ONMOUNT = 80, LEADING = 100, LUNGING = 80}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },	
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetraineremer",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 172},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 150, LUNGING = 60},
			  BLIPENABLED 				= true,
			  BLIPSPRITE      		    = -1327110633,
			  BLIPNAME        		    = "HORSE TRAINING EMER",	 
			  BLIPCOORDS                = vector3(1388.37, 255.26, 89.63), 
			  PROMPTNAME                = "EMERALD RANCH STABLES",			  
			  PROMPTCOORDS              = vector3(1391.29, 250.23, 89.98), 
			  PROMPTDISTANCE            = 5.0, 
			  MUSICENABLED              = true,
			  MUSICUSED                 = "BOU1_START",	
			  ---------------------------------
			  ...
			  CUTSCENE 						= true, 				  
			  CAMERACUTSCENE         	    = { 
			  [1] = {DELAY = 2000, CAMERACOORDS = {1387.05,  250.14,  91.45,  -17.94,   0.00,  -81.16,  51.28}, },
			  [2] = {DELAY = 2000, CAMERACOORDS = {1413.32,  241.38,  91.56,  -20.04,   0.00,  50.82,   51.27}, },
			  [3] = {DELAY = 2000, CAMERACOORDS = {1420.48,  258.29,  91.83,  -15.13,   0.00,  89.75,   51.28}, },
			  },

			  STARTPLAYERCOORDS         = vector4(1393.79, 253.06, 89.75, 296.2),
			  CHECKPOINTS               = {
			  [1]  = { COORDS = vector3(1414.15, 261.69, 90.04), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [2]  = { COORDS = vector3(1411.79, 248.03, 90.0), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [3]  = { COORDS = vector3(1400.82, 254.88, 89.61), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [4]  = { COORDS = vector3(1391.49, 239.87, 90.87), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [5]  = { COORDS = vector3(1400.33, 246.06, 91.11), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [6]  = { COORDS = vector3(1405.9, 251.2, 89.87), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [7]  = { COORDS = vector3(1409.36, 254.59, 90.95), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [8]  = { COORDS = vector3(1420.1, 263.02, 90.24), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [9]  = { COORDS = vector3(1399.69, 258.23, 89.55), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [10] = { COORDS = vector3(1390.45, 243.12, 90.65), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [11] = { COORDS = vector3(1410.57, 242.94, 89.83), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [12] = { COORDS = vector3(1417.26, 257.28, 90.24), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [13] = { COORDS = vector3(1401.34, 256.92, 89.6), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },
			  [14] = { COORDS = vector3(1389.59, 251.57, 89.86), DETECTIONDISTANCE = 3.0, RGB = {138,138,138} },			  
			  },
			  ---------------------------------
			  ---------------------------------
			  LUNGING_START_PLAYER_COORDS   = vector4(1376.15, 214.8, 91.29, 155.54),		  			  
			  LUNGING_OBSTACLES_ENABLED     = true, 			  
			  LUNGING_OBSTACLES         	= { 
			  [1]  = {ENABLED = true, MODEL = "MP001_P_JUMPHURDLES01X", COORDS = vector4(1376.15, 214.8, 91.29, 155.54) },       
			  },
		}, 	  
...
-- MCFARLANE RANCH 
      [6] = { 
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainermcf",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 70},
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 48, LEADING = 120, LUNGING = 60},
			  BLIPENABLED 				= true,
			  BLIPSPRITE      			= -1327110633,
			  BLIPNAME        		    = "HORSE TRAINING MCF",	  
...
-- STRAWBERRY
      [7] = { 
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainerstr",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	            = {ONMOUNT = 50, LEADING = 100 , LUNGING = 172},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 150, LUNGING = 60},
			  BLIPENABLED 				= true,
			  BLIPSPRITE      			= -1327110633,
			  BLIPNAME        		    = "HORSE TRAINING STR",	  
...
-- VALENTINE 
      [8] = { 
			  ...
			  JOBLOCKED                 = true,
			  JOB_LIST                  = {
			  [1] = {TRAINING_ACCESS = true, LABEL = "horsetrainerval",  XPGIVEN = {ONMOUNT = 90, LEADING = 340, LUNGING = 172}, COUNTDOWN = {ONMOUNT = 45, LEADING = 120, LUNGING = 60}},  
 			  },			  
			  DEFAULT_XP	           = {ONMOUNT = 20, LEADING = 100 , LUNGING = 40},	
			  DEFAULT_COUNTDOWN	        = {ONMOUNT = 45, LEADING = 120, LUNGING = 60},	
			  BLIPENABLED 				= true,
			  BLIPSPRITE      		    = -1327110633,
			  BLIPNAME        			= "HORSE TRAINING VAL ",	
