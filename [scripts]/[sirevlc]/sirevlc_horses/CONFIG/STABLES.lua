...
Config.Stables = {
    [1] = {
		...
		breeding_menu_enabled   = false,																			-- ONLY EFFECTIVE IF OWNING SIREVLC_BREEDING - ENABLE / DISABLE MENU BREEDING ACCESS FOR THAT STABLE
 		breeding_price = {																						-- ONLY EFFECTIVE IF OWNING SIREVLC_BREEDING - BREEDING PRICE 
									    -- ONLY EFFECTIVE IF OWNING SIREVLC_BREEDING - EVERY OTHER JOB THAN THE ONES LISTED BELOW WILL HAVE THIS PRICE 
		[1] = {DATABASE_JOB_LABEL = "horsetrainerval", GOLD = 0.0, DOLLARS = 500.0}, 							     
		},		
		...
		breeding_foal_pos     = {-357.35, 771.50, 116.11, -36.0},												-- ONLY EFFECTIVE IF OWNING SIREVLC_BREEDING - FOAL PREVIEW POS 
 		neutering_price = {
		[1] = {DATABASE_JOB_LABEL = "horsetrainerval", GOLD = 0.0, DOLLARS = 300.0}, 							    -- EVERY OTHER JOB THAN THE ONES LISTED BELOW WILL HAVE THIS PRICE 
		},	
 		rename_price = {
		...
		healing_price         = 200.0, 																	   		-- HEALING PRICE
    ...
    [2] = {
		...
		breeding_menu_enabled = false,																			 						
 		breeding_price = {
		[1] = {DATABASE_JOB_LABEL = "horsetrainerblk", GOLD = 0.0, DOLLARS = 500.0}, 							 
		...
		exitcamerapos         = {-849.55, -1378.73, 44.69, -13.72, 0.00, -3.50, 51.28},				  
		playergotocoords      = {-853.88, -1379.92, 43.62, 272.92},  
		healing_price         = 200.0, 																	   		 
		purchase_multiplier   = 1.0 ,																	   		 
		sell_multiplier  	  = 1.0 ,
        wagonpos			  = {-850.62, -1378.91, 43.57, 354.43},
		wagonpreviewcamoffset = {8.0, -2.0},													 		
		wagonspawnpos		  = {-850.62, -1378.91, 43.57, 354.43},		
    },
    ...
    [3] = {
		...
		breeding_menu_enabled   = false,																			 
 		breeding_price = {                                                                                       
		[1] = {DATABASE_JOB_LABEL = "horsetrainersai ", GOLD = 0.0, DOLLARS = 500.0}, 							     
    ...
    [4] = {
        name               	  = "Emerald Ranch Stables",
        title_given        	  = "Emerald Ranch Stables",	
		blipenabled        	  = true,
		blipsprite         	  = -643888085,		
        blipcoords         	  = {1407.74,  271.95, 89.58},	
        pedenabled            = true,							   										 
        pedmodel              = "u_m_m_bwmstablehand_01",							   						 
        pedscenario           = "WORLD_HUMAN_WAITING_IMPATIENT",
        pedcoords             = {1407.43, 272.3, 89.65, 286.48},			
        promptcoords       	  = {1408.32,  272.64, 89.58},
		promptdistance     	  = 1.5,
        horsepos           	  = {1409.28, 275.95, 89.58, 185.46},
		horsepreviewcamoffset = {3.0, 3.0},    
		horsepreviewcamoffset = {3.0, 3.0},                                                                    
		introcamerapos     	  = {1408.78, 277.89, 91.12, -15.65,  0.00, -170.29,  51.28},			           
		menucamera         	  = {1409.49, 273.34, 91.25, -26.77,  0.00, 103.12, 51.28},			           
		breeding_camera       = {1409.44, 295.58, 91.06, -23.77, 0.00, -165.57, 51.28},		 	   			 
		breeding_menu_enabled = false,																		 
 		breeding_price = {                                                                                     
		[1] = {DATABASE_JOB_LABEL = "horsetrainerem", GOLD = 0.0, DOLLARS = 500.0}, 							   
		},																			                           
		breeding_stallion_pos = {1411.3, 298.1, 88.71, 129.92},										 
		breeding_mare_pos     = {1405.93, 294.88, 88.7, 320.47},											   
		breeding_foal_pos     = {1412.2, 289.43, 88.86, 101.64},		                                       
 		neutering_price = {                                                                                    
		[1] = {DATABASE_JOB_LABEL = "OTHER_JOBS", GOLD = 0.0, DOLLARS = 300.0}, 							   
		},	                                                                                                   
 		rename_price = {                                                                                       
		...
		exitcamerapos         = {1423.60, 261.40, 91.69, -9.88, 0.00, 49.91, 51.28},				     
		playergotocoords      = {1409.35, 264.73, 89.7, 0.0},   
		healing_price      	  = 200.0,																	    
		purchase_multiplier   = 1.0,																	   		 
		sell_multiplier  	  = 1.0,
        wagonpos			  = {1423.92, 261.31, 90.59, 184.49},
		wagonpreviewcamoffset = {8.0, 8.0},                                                                 
		wagonspawnpos 		  = {1423.92, 261.31, 90.59, 184.49},		
    },
    ...
    [7] = { 
		...
		breeding_menu_enabled = false,																		 
 		breeding_price = {                                                                                     
		[1] = {DATABASE_JOB_LABEL = "horsetrainertum  ", GOLD = 0.0, DOLLARS = 500.0}, 							   
 		},																			                           
    ...
    [8] = { 
		...
		breeding_menu_enabled = false,																		 
 		breeding_price = {                                                                                     
		[1] = {DATABASE_JOB_LABEL = "horsetrainerstr    ", GOLD = 0.0, DOLLARS = 500.0}, 							   
	...
	[9] = {  
		...
		breeding_menu_enabled = false,																			 
 		breeding_price = {                                                                                       
		[1] = {DATABASE_JOB_LABEL = "horsetrainermcf  ", GOLD = 0.0, DOLLARS = 500.0}, 							     
