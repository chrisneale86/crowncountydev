...
Config.PERSONALITY_ENABLED              = false    	 -- IF SET TO TRUE THIS WILL ENABLE HORSE PERSONALITY SYSTEM / KEEP IN MIND WITHOUT METABOLISM ENABLED PERSONALITIES WILL NEVER EVOLVE	
Config.HORSE_KICK_ON_DEMAND_HASHKEY 	= 0x07CE1E61 -- IF HORSE KICK EFFECT IS ENABLED YOU'LL BE ABLE TO KICK PEDS AROUND YOU
Config.PERSONALITY_EFFECT_CHECK_DELAY	= 3  		 -- EVERY X MINUTE ONE OF THESE PERSONALITY EFFECTS WILL BE TRIGGERED IF VALUE = true OR VALUE > 0 
Config.PERSONALITY_EVOLUTION_ENABLED	= false       -- ENABLE / DISABLE THE PERSONALITY EVOLUTION SYSTEM BETWEEN BONDING STAGES  		 
...
[1] = {PERSONALITY        			= "DISTRUSTFUL",
	   ...
	   STABLE_PRICE_CHANGE_DOLLARS 	= 200, 
	   STABLE_PRICE_CHANGE_GOLD    	= 0, 
	   EFFECTS = {  
...
[5] = {EFFECT_NAME = "METABOLISM_EFFECT_HORSE_PEE" 					, LABEL = "Horse Pee"	    		, ENABLED = false,  COMPARISON = "SUPERIOR", HUNGER = false, THIRST = 100, LOVE = false }, -- IF  HUNGER_AND_THIRST_THRESHOLD > 200 THEN IT WILL ENABLE THAT EFFECT IN GAME
[6] = {EFFECT_NAME = "METABOLISM_EFFECT_HORSE_OVERWEIGHT" 			, LABEL = "Horse Overweight"	    , ENABLED = false,  COMPARISON = "SUPERIOR", HUNGER = 100, THIRST = false, LOVE = false },  
}
