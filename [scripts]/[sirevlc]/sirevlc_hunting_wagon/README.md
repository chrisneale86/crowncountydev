...
==================================================
			...
			--= SIREVLC HUNTING WAGON =--

==================================================

LINK: https://sire-vlc-scripts.tebex.io/package/6230128
...
ensure sirevlc_wagons
ensure sirevlc_hunting_wagon
````
...
Import `sirevlc_hunting_wagon.sql` into your database and confirm that your database is properly linked to your server.
